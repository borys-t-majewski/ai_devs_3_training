...
if __name__ == "__main__":
    ...
    # image_url = 'https://centrala.ag3nts.org/dane/barbara/IMG_1443_FT12.PNG'
    # test_instr = [{   'user': [{'type':'text','text':''},{'type':'image','url':image_url}]
    #           , 'system': f'''Reply in polish. Zwróć rysopis osoby lub osób na obrazku. Opisz znaki szczególne , kolor włosów, cokolwiek innego charakterystycznego.
    #           '''}]
    # print(test_instr)
    # reactions_ai_answer = asyncio.run(gather_calls(test_instr, client = client, tempature=.2, model = model))
    # print(reactions_ai_answer)